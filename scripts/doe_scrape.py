...
class Scraper():
    ...
    @staticmethod
    def collect_context(movie_tree, cast_crew_tree):
        ...
        movie_year = cast_crew_tree.xpath(movie_year_xpath)[0]
    ...
    def find_coworkers(href):
        ...
        return "http://www.imdb.com%s%s" % (naked_href, cast_crew_href[0]), movie_tree
    ...
    def get_coworkers(url):
        ...
        return cast_crew_jobs, cast_crew_tree
    ...
    def scrape():
        ...
        for movie, href in movie_links.items():
            ...
            cast_and_crew_url, movie_tree = Scraper.find_coworkers(href)
            ...
            # crew_jobs = Scraper.scrape_data(cast_crew_jobs, cast_crew_tree)

            print movie, cast_crew_data

            # print movie, crew_jobs

    # grabs the main target data, does the heaviest lifting
    @staticmethod
    def scrape_data(cast_crew_jobs, cast_crew_tree):
        # prepares for a loop
        current_credit = 0
        current_job_title = 0
